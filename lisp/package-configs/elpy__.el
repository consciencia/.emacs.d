...
(define-key elpy-mode-map (kbd "M-<next>") 'senator-next-tag)
(define-key elpy-mode-map (kbd "M-<prior>") 'senator-previous-tag)
(define-key elpy-mode-map (kbd "M-f") 'senator-fold-tag-toggle)
