...
(define-key general-key-map (kbd "C-k C-q") 'kbd-macro-query)
(define-prefix-command 'kmacro-counter-conf-map)
(define-key general-key-map (kbd "C-k C-c") 'kmacro-counter-conf-map)
(define-key kmacro-counter-conf-map (kbd "C-s") 'kmacro-set-counter)
(define-key kmacro-counter-conf-map (kbd "C-a") 'kmacro-add-counter)
